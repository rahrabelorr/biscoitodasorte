...
const biscoitoSorte = document.querySelector("#biscoitoSorte")
...
biscoitoSorte.addEventListener('click', handleTryClick)
...
function pickSorte() {
    let allSortes = sorte.length
    let randomNumber = Math.floor(Math.random() * allSortes)  
    screen2.querySelector("h2").innerText = `${sorte[randomNumber]}`
}
